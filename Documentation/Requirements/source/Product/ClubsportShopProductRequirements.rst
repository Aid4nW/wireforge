...
.. preq:: REQ-PROD-CS-002
   :status: Draft
   :importance: Medium
   :tags: performance, cost
   :related_stories: story:ClubsportShop

   Performance and Budget Balance
...
.. preq:: REQ-PROD-CS-004
   :status: Draft
   :importance: Medium
   :tags: documentation, serviceability
   :related_stories: story:ClubsportShop

   Clear, Serviceable Documentation
